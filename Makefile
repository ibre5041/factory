...
LDFLAGS= -bundle -bundle_loader test2 -undefined dynamic_lookup
...
libsubclass1: SubClass1.h SubClass1.cpp ABaseClass.h test_export.h
	g++ $(CXXFLAGS) -fPIC -DTEST_MAKE_DLL -c SubClass1.cpp
	ld $(LDFLAGS) SubClass1.o -o libSubClass1.so.1.0.1
